// Akbank PDF ekstre okuyucu — yalnızca Akbank için (bağımsız modül).
import {
...
const NOISE = /^(Sayfa|HESAP (ÖZET|EKSTRE)|IBAN\s*:|Hesap (No|Adı|Türü)|Müşteri|Şube|Döviz|Toplam|Tarih\s+Açıklama|www\.|Akbank)/i;
...
export const akbankParser: BankParser = {
  id: "akbank-pdf",
  bankCode: "akbank",
  label: "Akbank Ekstre Okuyucu",
  parse,
};
