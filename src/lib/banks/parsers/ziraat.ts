// Ziraat Bankası PDF ekstre okuyucu — yalnızca Ziraat Bankası için (bağımsız modül).
import {
...
const NOISE = /^(Sayfa|HESAP (ÖZET|EKSTRE)|IBAN\s*:|Hesap (No|Adı|Türü)|Müşteri|Şube|Döviz|Toplam|Tarih\s+Açıklama|www\.|T\\.? ?C\\.? Ziraat|ziraatbank)/i;
...
export const ziraatParser: BankParser = {
  id: "ziraat-pdf",
  bankCode: "ziraat",
  label: "Ziraat Bankası Ekstre Okuyucu",
  parse,
};
