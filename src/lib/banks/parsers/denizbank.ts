// DenizBank PDF ekstre okuyucu — yalnızca DenizBank için (bağımsız modül).
import {
...
const NOISE = /^(Sayfa|HESAP (ÖZET|EKSTRE)|IBAN\s*:|Hesap (No|Adı|Türü)|Müşteri|Şube|Döviz|Toplam|Tarih\s+Açıklama|www\.|DenizBank|denizbank)/i;
...
export const denizbankParser: BankParser = {
  id: "denizbank-pdf",
  bankCode: "denizbank",
  label: "DenizBank Ekstre Okuyucu",
  parse,
};
