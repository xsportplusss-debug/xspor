// Garanti BBVA PDF ekstre okuyucu — yalnızca Garanti BBVA için (bağımsız modül).
import {
...
const NOISE = /^(Sayfa|HESAP (ÖZET|EKSTRE)|IBAN\s*:|Hesap (No|Adı|Türü)|Müşteri|Şube|Döviz|Toplam|Tarih\s+Açıklama|www\.|Garanti|BBVA)/i;
...
export const garantiParser: BankParser = {
  id: "garanti-pdf",
  bankCode: "garanti",
  label: "Garanti BBVA Ekstre Okuyucu",
  parse,
};
