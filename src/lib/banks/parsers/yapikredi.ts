// Yapı Kredi PDF ekstre okuyucu — yalnızca Yapı Kredi için (bağımsız modül).
import {
...
const NOISE = /^(Sayfa|HESAP (ÖZET|EKSTRE)|IBAN\s*:|Hesap (No|Adı|Türü)|Müşteri|Şube|Döviz|Toplam|Tarih\s+Açıklama|www\.|Yap[ıi] (ve )?Kredi|yapikredi)/i;
...
export const yapikrediParser: BankParser = {
  id: "yapikredi-pdf",
  bankCode: "yapikredi",
  label: "Yapı Kredi Ekstre Okuyucu",
  parse,
};
